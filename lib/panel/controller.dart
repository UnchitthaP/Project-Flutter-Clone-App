...
class SystemButtonGroup extends StatelessWidget {
  static const _systemButtonColor = Color.fromARGB(255, 140, 213, 233);
      ...
      children: <Widget>[
        ...
        _Description(
          ...
          child: _Button(
              size: _SYSTEM_BUTTON_SIZE,
              enableLongPress: false,
              color: Color.fromARGB(255, 153, 26, 53),
              onTap: () {
...
class _Button extends StatefulWidget {
  ...
  const _Button({
    ...
    required this.onTap,
    this.icon,
    this.color = const Color.fromARGB(255, 184, 33, 243),
...
class _Description extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return DefaultTextStyle(
      child: widget,
      style: TextStyle(fontSize: 12, color: Color.fromARGB(255, 28, 4, 31)),
    );
  }
}
